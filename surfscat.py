...
#uncomment this code for user prompts to display each visual
"""
display_surf = input("Display Surface Plot?(y/n)")
if display_surf == 'y':
    surf()
display_scat = input("Display Scatter Plot?(y/n)")
if display_scat == 'y':
    scatter()
display_ss = input("Display Surface/Scatter Plot?(y/n)")
if display_ss == 'y':
    surfscat()
"""
